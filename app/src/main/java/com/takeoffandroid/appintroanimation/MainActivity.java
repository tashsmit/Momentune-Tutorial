...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawable drawable = res.getDrawable(R.drawable.polar_cub); //new Image that was added to the res folder

        rLayout.setBackground(drawable);

        viewPager = (ViewPager) findViewById(R.id.pager);
        landingBGView = findViewById(R.id.landing_backgrond);
        Button skip_button = (Button) findViewById(R.id.skipButton);
        skip_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                landingBGView.setVisibility(view.GONE);
            }
        });
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            itemView = getLayoutInflater().inflate(R.layout.viewpager_item, container, false);
